...
#==========================================================================================
JAVA_SSL_OPTS=" -Djavax.net.ssl.trustStore=/home/dubbo/cacerts -Djavax.net.ssl.trustStorePassword=changeit "
JAVA_OPT="-server -Xms256m -Xmx256m -Xmn512m -XX:MetaspaceSize=64m -XX:MaxMetaspaceSize=256m"
JAVA_OPT="${JAVA_SSL_OPTS} ${JAVA_OPT} -XX:-OmitStackTraceInFastThrow"
